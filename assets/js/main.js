...
const partic = document.querySelector("div.particles-js");
...
themeButton.addEventListener("click", () => {
  ...
  // partic.id = [selectedTheme === "dark" ? "particles-js" : "nones"];
  ...
  partic.id = [getCurrentTheme() === "dark" ? "nones" : "particles-js"];
});
...
var typed = new Typed(".typing-footer", {
  strings: ["Data Analysis", "Fullstack Development"],
  typeSpeed: 15,
  backSpeed: 60,
  loop: true,
  cursorChar: "|",
